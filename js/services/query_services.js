...
// URL API
const apiUrl = "http://172.27.0.154:8000/api/radius/service";
...
fetch(apiUrl)
  ...
  .then(async (data) => {
    ...
    createServiceButton.addEventListener("click", () => {
      ...
      const createUsergroupUrl = "http://172.27.0.154:8000/api/radius/service";
    ...
    for (const services of data.message) {
      ...
      deleteButton.addEventListener("click", () => {
        ...
        deleteButtonmodal.addEventListener("click", (event) => {
          ...
          const deleteUserUrl = `http://172.27.0.154:8000/api/radius/service/${services.srvid}`;
      ...
      editButton.addEventListener("click", () => {
        ...
        updateButton.addEventListener("click", () => {
          ...
          const putUserUrl = `http://172.27.0.154:8000/api/radius/service/${services.srvid}`;
          const requestOptions = {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
